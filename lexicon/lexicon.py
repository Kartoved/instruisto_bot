...
NEWS: str = ''' Сообщение об новых функциях в обновлении
'''
...
def calculate_progress(list_of_words: list):
    with open('users_data/164720191/explored_words.json', encoding='utf-8') as f:
        ...
        print(f'\nНачал учить {len(memorized_words)}'
            f'\nЗнаешь хорошо {len(know_good)}'
            f'\nЗнаешь отлично {len(know_perfect)}'
            f'\nПрогресс {round(len(know_perfect)/1194*100)+round(len(know_good)/1194*10, 2)}')
