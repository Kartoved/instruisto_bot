...
RESET_MESSAGE: str = f'‼️‼️‼️ Вы уверены, что хотите сбросить прогресс? ‼️‼️‼️\n\nЭто действие НЕОБРАТИМО! Сбросится статистика, удалятся все изученные слова и придётся их учить заново!'
