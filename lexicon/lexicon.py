...
— Изучено слов \
<strong>{round(len(list_name)/(1194/100), 1)}%</strong>\
({len(list_name)} из 1194)\n— Сегодня слов для повторения: \
